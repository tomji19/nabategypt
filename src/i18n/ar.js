...
const ar = {
  ...
  sizeRequired: 'يرجى اختيار المقاس للمتابعة',
  ...
  brightLightDirect: 'إضاءة ساطعة مباشرة',
  brightLightIndirect: 'إضاءة ساطعة غير مباشرة',
  anyCare: 'أي مستوى عناية',
  anyAvailability: 'الكل',
  easyCare: 'عناية سهلة',
  moderateCare: 'متوسطة',
  expertCare: 'للخبراء',
  ...
  careTab: 'العناية',
  careFallback: 'ملاحظات العناية لهذه النبتة ستظهر هنا قريباً.',
  reviews: 'التقييمات',
